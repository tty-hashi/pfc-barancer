...
セブンイレブンの商品から、自分が欲しい栄養素を含む商品を容易に見つけられるアプリです。

昨今の健康志向の高まりにより、3 大栄養素のバランスを意識されている方が増えています。
そうすると、「タンパク質 10g 以上欲しいけど、脂質は無いほうがいいな」といった要望が出てきます。
そんなとき、今までではコンビニ商品を一点一点確認する必要がありました。
しかし、このアプリを使用すれば、自分の条件に合った商品を簡単に見つけることができます。
その上、商品を組み合わせてオリジナルのメニューを作成してそれを保存することも可能です。

## 作成した経緯

昼食は、コンビニを毎日利用していました。
健康創りのために昼食では、タンパク質を 20g 以上摂ること条件としていたので、毎日サラダチキンを食べていました。
もちろん飽きました。そこで、タンパク質 20g 以上摂れる別の商品を探したところ、なぜか買い物カゴにはスイーツやお菓子が入るようになりました。これではダメだとサラダチキンを食べる日々へ…といったことを繰り返してました。

上記には、2 つ問題点があると感じました。
① 自分の条件に合った商品を探すのが困難(同じ商品ばかりになる)
② 商品を探していたら、セブンイレブンのマーケティングにハマる(不要なものを買う)
