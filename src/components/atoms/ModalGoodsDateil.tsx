...
import { Box, Flex, Image, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Spacer, Text, useDisclosure } from "@chakra-ui/react";
    ...
    <>
      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <GoodsTitle>手巻おにぎり白加賀梅　（群馬県産梅使用）</GoodsTitle>
          <GoodsPrice>115円（税込124.20円）</GoodsPrice>
